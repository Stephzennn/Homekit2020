#!/bin/bash
#SBATCH --job-name=xgboost_neg_finetuned
#SBATCH --nodes=1
...
python Homekit2020/src/models/models/PatchTST_self_supervised/XgBoost.py \
    ...
    --checkpoint "/home/hice1/ezg6/projects/saved_models/Wearable/masked_patchtst/Negative_only_finetuned_4132026/Wearable_patchtst_finetuned_cw10080_tw1_patch1440_stride180_epochs-finetune60_model1.pth" \
    --out_dir    "/home/hice1/ezg6/projects/saved_models/Wearable/masked_patchtst/Negative_only_finetuned_4132026" \
    --xgb_model_id 1 \
