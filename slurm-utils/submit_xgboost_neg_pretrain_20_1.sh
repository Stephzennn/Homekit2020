#!/bin/bash
#SBATCH --job-name=xgboost_neg_pretrain_20_1
#SBATCH --nodes=1
...
python Homekit2020/src/models/models/PatchTST_self_supervised/XgBoost.py \
    ...
    --checkpoint "/home/hice1/ezg6/projects/saved_models/Wearable/masked_patchtst/Negative only training 4132026/patchtst_pretrained_cw10080_patch1440_stride180_epochs-pretrain100_mask0.5_model12.pth" \
    --out_dir    "/home/hice1/ezg6/projects/saved_models/Wearable/masked_patchtst/Negative only training 4132026" \
    --xgb_model_id 2 \
