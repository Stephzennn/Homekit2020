# ============================================================
# LEGACY VERSION — original PatchTST finetune script
# ============================================================
# This is the original finetune script before adaptation for
# the Wearable binary classification task.
#
# Key differences from the active patchtst_finetune.py:
#   - Uses head_type='prediction' and MSELoss (forecasting task)
#   - No DDP / distributed support
#   - No BCEWithLogitsLoss or ROC-AUC / PR-AUC test metrics
#   - args parsed at module level (not inside main/functions)
#
